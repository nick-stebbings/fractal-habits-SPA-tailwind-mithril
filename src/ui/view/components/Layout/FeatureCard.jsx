    ...
    >
      ...
      <div className="feature-card-content bg-balance-basic-black opacity-90 z-20 mt-8 font-serif font-bold leading-10 tracking-wide text-white">
        ...
        <button
          type="button"
          onclick={function () {
            let contentContainer = vnode.dom.querySelector(
              ".feature-card-content"
            );
            let button = vnode.dom.querySelector("button");
            button.textContent =
              button.textContent == "Hide" ? "Find out more" : "Hide";
            vnode.dom
            ...
            contentContainer.style.maxHeight =
              maxHeight !== "128px" ? `${height + 16}px` : "128px";
          }}
