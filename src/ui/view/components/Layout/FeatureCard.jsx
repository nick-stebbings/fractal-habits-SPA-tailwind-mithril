...
const FeatureCard = {
  ...
  view: (vnode) => (
    <div
      className={
        vnode.attrs.wide
          ? 'feature-card mb-4 wide relative flex flex-col items-end col-span-5 text-right shadow-lg bg-black'
          : 'feature-card mb-4 xl:wide relative flex flex-col items-end col-span-5 text-right shadow-lg bg-black'
      }
    >
      <h2 className="font-sans md:w-3/4 md:text-center relative z-10 self-end w-1/2 font-extrabold text-right">
        {vnode.attrs.title}
      </h2>
      <div className="feature-card-content lg:rounded-full md:feature-card-content-wide bg-balance-basic-black opacity-90 text-gray-50 z-20 mt-8 font-serif font-bold leading-10 tracking-wide">
        ...
        <div
          className="long-content-wrapper rounded-3xl hidden p-8 font-serif tracking-tight text-left text-justify text-black bg-gray-100"
        >
