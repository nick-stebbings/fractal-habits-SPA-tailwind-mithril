  ...
  view: (vnode) => (
    ...
    >
      ...
      <div className="feature-card-content lg:rounded-full md:feature-card-content-wide bg-balance-basic-black opacity-90 text-gray-50 z-20 mt-8 font-serif font-bold leading-10 tracking-wide">
        ...
        <div
          className="long-content-wrapper rounded-3xl md:p-6 xl:p-8 md:overflow-y-auto hidden p-4 font-serif tracking-tight text-left text-justify text-black bg-gray-100"
          style="max-height: 92%"
        >
